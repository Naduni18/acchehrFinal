...
class calender_eventsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('calender_events')->insert([
            ...
            'start' => '2020-05-18 07:00',
            'end'=>'2020-05-18 08:00',
            'startTime'=>NULL,
            'endTime'=>NULL,
            'startRecur'=>NULL,
            'endRecur'=>NULL,
        ...
        DB::table('calender_events')->insert([
            ...
            'start' => '2020-05-12 07:00',
            'end'=>'2020-05-12 08:00',
            'startTime'=>NULL,
            'endTime'=>NULL,
            'startRecur'=>NULL,
            'endRecur'=>NULL,
        ...
        DB::table('calender_events')->insert([
            ...
            'start' => '2020-06-18 07:00',
            'end'=>'2020-06-18 08:00',
            'startTime'=>NULL,
            'endTime'=>NULL,
            'startRecur'=>NULL,
            'endRecur'=>NULL,
