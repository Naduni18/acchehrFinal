                    ...
                    <form id="addCandidateForm" method="post" enctype="multipart/form-data" action="{{ route('recruitment.store') }}" autocomplete="off">
                        ...
                        <div class="pl-lg-4">
                            ...
                            <div class="form-group{{ $errors->has('cv_document') ? ' has-danger' : '' }}">
                                ...
                                <input type="file" name="cv_document" id="input-cv_document" class="form-control form-control-alternative{{ $errors->has('cv_document') ? ' is-invalid' : '' }}" required>
                            </div>
                            ...
                            <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                                ...
                                <div class="form-group{{ $errors->has('applied_job_position') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="applied_job_position" id="input-applied_job_position" class="form-control form-control-alternative{{ $errors->has('applied_job_position') ? ' is-invalid' : '' }}" placeholder="{{ __('Applied Job Position') }}" autofocus>
